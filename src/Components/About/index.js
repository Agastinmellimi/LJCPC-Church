            ...
            <ContentContainer>
                <Quotation>
                  {language === 'english' ? (
                    ...
                    అమెరికన్ సొసైటీ ఆఫ్ క్వశ్చన్డ్ డాక్యుమెంట్ ఎగ్జామినర్స్‌కు చెందిన Mr. జార్జ్ J. లాసీ ద్వారా ఫోటో ఒక అతీంద్రియ జీవి యొక్క ప్రామాణికమైన సంగ్రహంగా ధృవీకరించబడింది.
                    </>
                  )}
                </Quotation>
