        ...
        return (
          <Container>
            ...
            >
              <BannerImage
                alt="church"
                src="https://res.cloudinary.com/dkrpgt9kd/image/upload/v1710051774/jfqwth5p1vptaofog8eu.png"
              />
              <BannerContent>
                <Heading>
                  {language === "english"
                    ? "Lord Jesus Christ Prayer Church"
                    : "ప్రభువైన యేసు క్రీస్తు ప్రార్థన మందిరం."}
                </Heading>
              </BannerContent>
            </BannerContainer>
            <TabsContentContainer>
              <TabsContainer>
                ...
                <Tab
                  graph="true"
                  onClick={() => navigate("/children-progress")}
                >
                  <TabNameContainer>
                    <TabName>
                      {language === "english"
              ...
              <AboutTab onClick={() => navigate("/about")}>
                <TabNameContainer>
                  <TabName>
                    {language === "english" ? "About" : "వివరాలు"}
                  </TabName>
                  <SiInformatica
                    size={22}
                    data-aos="fade"
            ...
            <WidgetsContainer>
              ...
              <Widgets youtube="true">
                <a
                  href="https://www.youtube.com/channel/UCi2Qnb1x9WdyEwvMLw6EnzQ"
                  target="_blank"
                  rel="noreferrer"
                  style={{
                    textDecoration: "none",
